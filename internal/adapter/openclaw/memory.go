...
// ImportMemory reads MEMORY.md / AGENTS.md / CLAUDE.md / DREAMS.md and writes
// one memory artifact. Uses Format: "markdown" — interoperable with claudecode,
// codex, kilo, and hermes memories.
